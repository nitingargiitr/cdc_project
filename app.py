...
if 'sqft_above' not in st.session_state or st.session_state.sqft_above is None:
    st.session_state.sqft_above = st.session_state.get('sqft_living', 1500)

# Use sqft_living instead of sqft for consistency
sqft = st.session_state.get('sqft_living', 1500)
